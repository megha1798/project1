...
public class StaffReportListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staff_report_list);

        tvTitle = (TextView) findViewById(R.id.tvTitle);
        tvTitle.setText("Report List");
    ...
    public class GetList extends AsyncTask<Void,Void, AllRequest>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(StaffReportListActivity.this);
        ...
        protected AllRequest doInBackground(Void... voids)
        {
            ...
            result = new APICall().GetStaffReport(user_id);
            return result;
        }
        ...
        protected void onPostExecute(AllRequest allRequest) {
            ...
            if(allRequest !=null)
            {
                ...
                Toast.makeText(StaffReportListActivity.this, "No History ", Toast.LENGTH_LONG).show();
    ...
    public class ListAdapter extends BaseAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if(convertView ==null)
            {
                ...
                convertView= inflater.inflate(R.layout.layout_item_report,parent,false);
                ...
                Holder.tvReport = (TextView) convertView.findViewById(R.id.tvReport);
            ...
            Holder.tvReport.setText(AllRequests.get(position).getReport_Description());
    ...
    {
        TextView tvTime, tvDate, tvAddress ,tvName ,tvDescription ,tvServiceName ,tvEstimate,tvReport;
    }
